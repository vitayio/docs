...
| https://vitay.io/article/27-can-i-upload-files-and-resumes-to-the-candidates-profile | Can I upload files and resumes to the candidates profile? | /candidates-reference-requests/candidate-documents | written |
...
| https://vitay.io/article/16-settings-configuration | Settings - Configuration | /account-configuration/firm-configuration | written |
| https://vitay.io/article/45-emails | Settings - Emails | /account-configuration/email-text-and-page-templates | written |
| https://vitay.io/article/54-settings-plugins | Settings - General and Plugins | /account-configuration/plugins | written |
...
| https://vitay.io/article/44-settings-ref-requests | Settings - Ref. Requests | /account-configuration/reference-request-settings | written |
| https://vitay.io/article/15-text-messages | Settings - Texts | /account-configuration/email-text-and-page-templates | written |
...
| https://vitay.io/article/48-how-to-pick-dates | How to pick dates | /reference-providers/date-fields | written |
...
| https://vitay.io/article/30-how-to-provide-a-new-reference | Providing a new reference | /reference-providers/add-another-reference | written |
...
| https://vitay.io/article/49-how-can-i-see-or-get-a-copy-of-my-reference-responses | Requesting a copy of my response or reference(s) response | /reference-providers/copy-of-my-responses | written |
...
| https://vitay.io/article/23-unable-to-submit-my-reference | Unable to submit my reference form | /reference-providers/edit-my-answers | written |
...
| https://vitay.io/article/51-i-am-unable-to-type-answers-or-fill-in-certain-fields | Difficulty typing answers or fill in certain fields | /reference-providers/trouble-submitting | written |
...
| https://vitay.io/article/42-automatically-assigning-question-sets | Automatically assigning question sets | /account-configuration/relationships-and-jobs | written |
...
| https://vitay.io/article/34-ip-conflicts | IP conflicts | /candidates-reference-requests/ip-conflicts-and-reference-edits | written |
...
| https://vitay.io/article/20-reference-evaluation-scoring | Reference Evaluation (scoring) — uncategorised on help.vitay.io | /candidates-reference-requests/read-a-completed-reference | written |
...
| Old URL | Old Title | New Path | Status |
|---|---|---|---|
| https://vitay.io/article/50-background-screening | Background screening | /candidates-reference-requests/background-screening | written |
| https://vitay.io/article/47-reference-signature | Candidate and Reference signature | /account-configuration/signatures | written |
| https://vitay.io/article/12-pre-screening | Pre-screening | /candidates-reference-requests/pre-screening | written |
...
| https://vitay.io/article/41-recruiter-feedback | Recruiter feedback | /feedback/candidate-feedback | written |
...
| Metric | Count |
|---|---|
| Total old articles enumerated | 52 (51 categorised + uncategorised article 20) |
| Mapped to **written** pages | 52 |
| Mapped to **stub** pages | 0 |
| **Dropped** | 0 |
| Lead Generation category (empty) | 0 |

### Dropped articles

_None. Article 27 was re-mapped to the candidate documents page on 2026-09-10 once recruiter-side uploads were documented._

### Articles mapped to stubs

_None remaining as of 2026-09-10 — every former stub now points at a written page (see rows above)._
